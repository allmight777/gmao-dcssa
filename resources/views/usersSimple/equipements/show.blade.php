                        ...
                        <div>
                            ...
                            <p class="mb-0 text-white-50">
                                ...
                                @if ($equipement->numero_serie)
                                    <span class="ms-3"><i class="fas fa-barcode me-2"></i>S/N:
                                        {{ $equipement->numero_serie }}</span>
                                @endif
                            </p>
                        </div>
                        <span class="badge-custom bg-{{ $isAvailable['color'] }} text-white px-4 py-2 fs-6">
                            <i
                                class="fas fa-{{ $isAvailable['color'] == 'success'
                                    ? 'check-circle'
                                    : ($isAvailable['color'] == 'warning'
                    ...
                    <div class="card-body-modern">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="info-card">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <h6 class="info-value">{{ $equipement->typeEquipement->libelle ?? 'Non spécifié' }}
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-card">
                                    <div
                                        class="info-icon bg-{{ $equipement->etat == 'neuf' || $equipement->etat == 'bon' ? 'success' : ($equipement->etat == 'moyen' ? 'warning' : 'danger') }}">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <h6 class="info-value">
                                            <span
                                                class="badge-custom bg-{{ $equipement->etat == 'neuf' || $equipement->etat == 'bon' ? 'success' : ($equipement->etat == 'moyen' ? 'warning' : 'danger') }}">
                            ...
                            <div class="col-md-6">
                                <div class="info-card">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <h6 class="info-value">
                                            {{ $equipement->date_mise_service ? $equipement->date_mise_service->format('d/m/Y') : 'Non spécifié' }}
                                        </h6>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @if ($equipement->prix_achat)
                                            <div class="col-md-6">
                                                <div class="d-flex justify-content-between py-2">
                                                    ...
                                                    <span
                                                        class="fw-bold">{{ number_format($equipement->prix_achat, 2, ',', ' ') }}
                                                        FCFA</span>
                                                </div>
                                            </div>
                                        @endif
                    ...
                    <div class="col-md-6">
                        <div class="card-modern h-100">
                            ...
                            <div class="card-body-modern">
                                ...
                                <h4 class="text-center fw-bold mb-2">{{ $equipement->localisation->nom ?? 'Non spécifié' }}
                                </h4>
                        ...
                        <div class="card-modern h-100">
                            ...
                            <div class="card-body-modern">
                                ...
                                <h4 class="text-center fw-bold">
                                    {{ $equipement->serviceResponsable->nom ?? 'Non spécifié' }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="timeline">
                                @foreach ($equipement->interventions as $intervention)
                                    <div class="timeline-item">
                                        <div
                                            class="timeline-marker bg-{{ $intervention->statut == 'terminee' ? 'success' : ($intervention->statut == 'en_cours' ? 'warning' : 'secondary') }}">
                                        </div>
                                        <div class="timeline-content p-3 rounded shadow-sm bg-white">

                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <h6 class="fw-bold text-primary mb-0">
                                                    <i class="fas fa-tools me-1"></i>
                                                    {{ ucfirst($intervention->type_intervention) }}
                                                </h6>

                                                <span
                                                    class="badge rounded-pill px-3 py-2
            bg-{{ $intervention->statut == 'terminee' ? 'success' : ($intervention->statut == 'en_cours' ? 'warning text-dark' : 'secondary') }}">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                ...
                                                <span class="badge bg-info text-dark px-3 py-2">
                                                    💼 Main d'œuvre :
                                                    {{ number_format($intervention->Cout_Main_Oeuvre, 0, ',', ' ') }} FCFA
                                                </span>

                                                <span class="badge bg-primary px-3 py-2">
                                                    🧩 Pièces :
                                                    {{ number_format($intervention->Cout_Pieces, 0, ',', ' ') }} FCFA
                                                </span>

                                                <span class="badge bg-dark px-3 py-2">
                                                    💰 Total : {{ number_format($intervention->Cout_Total, 0, ',', ' ') }}
                                                    FCFA
                                                </span>
                                            ...
                                            <div class="d-flex flex-wrap gap-2 mb-2">
                                                ...
                                                <span class="badge bg-light text-dark border px-3 py-2">
                                                    📅 Début : {{ $intervention->Date_Debut ?? 'Non défini' }}
                                                </span>

                                                <span class="badge bg-light text-dark border px-3 py-2">
                                                    ⏰ Heure : {{ $intervention->Heure_Debut ?? 'Non défini' }}
                                                </span>
                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-body-modern text-center">
                        <div class="availability-icon mb-3">
                            <i
                                class="fas fa-{{ $isAvailable['color'] == 'success' ? 'check-circle' : ($isAvailable['color'] == 'warning' ? 'exclamation-triangle' : 'times-circle') }} fa-4x text-{{ $isAvailable['color'] }}"></i>
                        </div>
                            ...
                            <div class="contract-card mt-4">
                                ...
                                <div class="contract-info">
                                    ...
                                    <p class="text-muted mb-0">
                                        ...
                                        Du {{ $equipement->contrat->date_debut->format('d/m/Y') }} au
                                        {{ $equipement->contrat->date_fin->format('d/m/Y') }}
                                    </p>
                                </div>
                            </div>
                        @endif
