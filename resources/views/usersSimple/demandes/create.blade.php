        ...
        <div class="col-12 col-lg-8 col-xl-7">
            <div class="card card-modern">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('user.demandes.store') }}" method="POST" id="demandeForm">
                        @csrf
                        ...
                        <div class="form-step active" data-step="1">
                            <div class="step-header">
                                ...
                                <h5 class="step-title">Sélectionnez l'équipement</h5>
                                <p class="step-subtitle">Choisissez l'équipement qui nécessite une intervention</p>
                            </div>
                                ...
                                <div class="select-wrapper">
                                    <select class="form-control-modern @error('ID_Equipement') is-invalid @enderror"
                                        ...
                                        <option value="{{ $equipement->id }}"
                                                {{ old('ID_Equipement') == $equipement->id ? 'selected' : '' }}
                        ...
                        <div class="form-step" data-step="2">
                            <div class="step-header">
                                ...
                                <p class="step-subtitle">Précisez le type et l'urgence de l'intervention</p>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="select-wrapper">
                                        <select class="form-control-modern @error('Type_Intervention') is-invalid @enderror"
                                            ...
                                            <option value="maintenance_preventive" {{ old('Type_Intervention') == 'maintenance_preventive' ? 'selected' : '' }}>
                                                🛡️ Maintenance préventive
                                            </option>
                                            <option value="maintenance_corrective" {{ old('Type_Intervention') == 'maintenance_corrective' ? 'selected' : '' }}>
                                                🔧 Maintenance corrective
                                            </option>
                                            <option value="reparation" {{ old('Type_Intervention') == 'reparation' ? 'selected' : '' }}>
                                                🔨 Réparation
                                            </option>
                                            <option value="calibration" {{ old('Type_Intervention') == 'calibration' ? 'selected' : '' }}>
                                                ⚖️ Calibration
                                            </option>
                                            <option value="verification" {{ old('Type_Intervention') == 'verification' ? 'selected' : '' }}>
                                                ✅ Vérification
                                            </option>
                                            <option value="controle" {{ old('Type_Intervention') == 'controle' ? 'selected' : '' }}>
                                                🔍 Contrôle
                                            </option>
                                            <option value="autre" {{ old('Type_Intervention') == 'autre' ? 'selected' : '' }}>
                                                📋 Autre
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="select-wrapper">
                                        <select class="form-control-modern @error('Urgence') is-invalid @enderror"
                                                ...
                                                required>
                                            <option value="">Sélectionnez...</option>
                                            <option value="normale" {{ old('Urgence') == 'normale' ? 'selected' : '' }}>
                                                🟢 Normale (5 jours)
                                            </option>
                                            <option value="urgente" {{ old('Urgence') == 'urgente' ? 'selected' : '' }}>
                                                🟡 Urgente (48h)
                                            </option>
                                            <option value="critique" {{ old('Urgence') == 'critique' ? 'selected' : '' }}>
                                                🔴 Critique (immédiat)
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <div class="form-step" data-step="3">
                            <div class="step-header">
                                ...
                                <p class="step-subtitle">Donnez un maximum de détails sur la panne</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control-modern textarea-modern @error('Description_Panne') is-invalid @enderror"
                                          ...
                                          rows="6"
                                          required
                                          placeholder="Décrivez le problème en détail...">{{ old('Description_Panne') }}</textarea>
                        ...
                        <div class="form-navigation">
                            ...
                            <div class="ms-auto d-flex gap-3">
                                <a href="{{ route('user.demandes.index') }}" class="btn btn-cancel">
