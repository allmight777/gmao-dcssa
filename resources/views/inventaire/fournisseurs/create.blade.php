...
@section('page-title', 'Créer un nouveau fournisseur')
...
<div class="create-service-container">
    ...
    <form method="POST" action="{{ route('inventaire.fournisseurs.store') }}" class="service-form" id="fournisseurForm">
        @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="date" id="date_premiere_commande" name="date_premiere_commande" 
                               value="{{ old('date_premiere_commande') }}">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="date" id="date_derniere_commande" name="date_derniere_commande" 
                               value="{{ old('date_derniere_commande') }}">
                    </div>
                    ...
                    <div class="input-with-icon">
                        ...
                        <select id="evaluation" name="evaluation" class="form-select">
                            ...
                            @foreach($evaluations as $key => $label)
                                <option value="{{ $key }}" {{ old('evaluation') == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function generateCodeFournisseur() {
        ...
        document.getElementById('code_fournisseur').addEventListener('focus', function() {
            if (!this.value.trim()) {
                generateCodeFournisseur();
            }
        });
        ...
        form.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Êtes-vous sûr de vouloir créer ce fournisseur ?',
                icon: 'question',
        ...
        // Définir la date d'aujourd'hui pour les dates de commande par défaut
        const today = new Date().toISOString().split('T')[0];
        
        // Date première commande : si vide, mettre aujourd'hui
        const premiereCommandeInput = document.getElementById('date_premiere_commande');
        if (premiereCommandeInput && !premiereCommandeInput.value) {
            premiereCommandeInput.value = today;
        }
        
        // Date dernière commande : si vide, mettre aujourd'hui
        const derniereCommandeInput = document.getElementById('date_derniere_commande');
        if (derniereCommandeInput && !derniereCommandeInput.value) {
            derniereCommandeInput.value = today;
        }
